...
const slides = [
  {
    ...
    description:
      'Servicios de maquillaje profesional para eventos especiales, bodas y sesiones fotográficas.',
    cta: 'Reservar Cita',
  },
  {
    id: 2,
    image: '/artistico2.jpeg',
    title: 'Maquillaje de Novia',
    subtitle: 'Tu día perfecto merece un look perfecto',
    description:
      'Especialistas en maquillaje nupcial con técnicas de larga duración para tu día especial.',
    cta: 'Ver Paquetes',
  },
  {
    id: 3,
    ...
    description:
      'Asesoramiento personalizado en maquillaje y cuidado de la piel adaptado a ti.',
    cta: 'Consultar',
  },
];
