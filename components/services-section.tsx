...
const services = [
  {
    ...
    icon: Heart,
    price: "Desde $150",
    features: ["Prueba previa", "Maquillaje de larga duración", "Retoques incluidos"],
  },
  {
    id: 2,
    title: "Maquillaje Social",
    description: "Perfecto para eventos, fiestas y ocasiones especiales. Adaptamos el look a tu estilo y personalidad.",
    image: "/glamorous-evening-makeup.png",
    icon: Sparkles,
    price: "Desde $80",
    features: ["Consulta de estilo", "Maquillaje personalizado", "Productos premium"],
  },
  {
    id: 3,
    ...
    image: "/professional-makeup-photoshoot.png",
    icon: Camera,
    price: "Desde $120",
    features: ["Maquillaje HD", "Resistente a luces", "Retoques durante sesión"],
  },
  {
    id: 4,
    ...
    image: "/friends-makeup-party.png",
    icon: Users,
    price: "Consultar",
    features: ["Descuentos grupales", "Servicio a domicilio", "Coordinación de horarios"],
  },
]
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Ofrecemos una amplia gama de servicios de maquillaje profesional adaptados a cada ocasión especial. Cada
            servicio incluye consulta personalizada y productos de alta calidad.
          </p>
        </div>
