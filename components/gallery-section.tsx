...
const galleryImages = [
  {
    id: 1,
    src: 'https://res.cloudinary.com/dcuethtco/image/upload/v1754769847/galeria_ypyqd8.jpg',
    alt: 'Maquillaje natural con piel radiante',
    category: 'Social',
  },
  {
    id: 2,
    src: 'https://res.cloudinary.com/dcuethtco/image/upload/v1754769847/galeria2_l666cw.jpg',
  ...
  {
    id: 10,
    src: 'https://res.cloudinary.com/dcuethtco/image/upload/v1754769847/galeria11_dbvj0k.jpg',
